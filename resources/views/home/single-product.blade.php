                            ...
                            <div class="swiper-wrapper">
                                @foreach($product->images as $image)
                                    <div class="swiper-slide">
                                        <img class="rounded-xl cursor-pointer" src="{{asset('/adm/products/images/'. $image)}}" />
                                    </div>
                                @endforeach
                            </div>
                            ...
                            <div class="grid grid-cols-12 mt-4">
                                <div class="col-span-12 lg:col-span-8 p-4">
                                    <ul class="leading-8 text-stone-500">
                                        <li>ولتاژ: {{$product->voltage}} ولت</li>
                                        <li>منبع تغذیه: {{$product->power}}</li>
                                        <li>مدل: {{$product->model}}</li>
                                        <li>وزن: {{$product->weight}} گرم</li>
                                        <li>بازدید: {{$product->visit}}</li>
                                        <li>رنگ: <p class="btn" style="background-color:{{$product->color}}">{{$product->color}}</p></li>
                                        <li>اقلام همراه:
                                            @foreach($product->items as $item)
                                                <button type="button" class="btn btn-outline-primary mt-2">{{$item}}</button>
                                            @endforeach
                                        </li>
                                    </ul>
                                    ...
                                    <div>
                                        <a class="border px-4 py-2 rounded-xl" href="{{route('compare', $product->id)}}">افزودن به مقایسه</a>
                                    </div>
                                </div>
